    ...
    <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0 }}>
        <GradientBlinds
          ...
          distortAmount={0}
          shineDirection="left"
          mixBlendMode="lighten" // or normal if you want it opaque
        />
      </div>
      ...
      <div className="container animate-fade-in" style={{ padding: '4rem 1rem', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        <header style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'var(--color-text-primary)', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto', textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>
