    ...
    useEffect(() => {
        ...
        addPage(
            <div style={{ textAlign: 'center', marginTop: '30%' }}>
                <h1 style={{ fontSize: '24pt', fontWeight: 'bold', color: 'black', marginBottom: '2rem' }}>
                    {data.title?.toUpperCase()}
                </h1>
                <p style={{ fontSize: '16pt', color: 'black' }}>A PROJECT REPORT</p>
            </div>
        );
        ...
        refChunks.forEach((chunk, i) => {
            addPage(
                <>
                    ...
                    <ul style={{ paddingLeft: '1.5rem', color: 'black' }}>
                        {chunk.map((ref, rIdx) => (
